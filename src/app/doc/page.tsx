        ...
        content: (
            <div className="prose prose-invert max-w-none text-gray-300 leading-relaxed space-y-4">
                ...
                <p>
                    ...
                    difficult if you are not a technical expert and do not have a robust
                        ...
                        <li key={item.id}>
                            ...
                            >
                                ...
                                {item.items && item.items.length > 0 && (
                                    <ChevronIcon className={`transition-transform duration-300 ${openDropdowns[item.id] ? 'rotate-90' : 'rotate-0'}`} />
                                )}
                            </div>
...
export default function DocPage() {
    const [activeContent, setActiveContent] = useState<DocNavItem | DocNavSubItem>(docNavItems[0]);
